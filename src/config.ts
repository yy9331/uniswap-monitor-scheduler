...
const config: Config = {
    ...
    // 定时任务设置
    CRON_SCHEDULES: [                    // 多个定时任务
        '0 7 * * *',                     // 每天早上 7:00 执行
        '0 19 * * *'                     // 每天晚上 19:00 执行
    ],
    TIMEZONE: 'UTC',                     // 时区设置（与系统时区保持一致）
    ...
    // 以太坊设置
    // ETHEREUM_RPC: 'https://eth.merkle.io',
    // ETHEREUM_RPC: 'https://rpc.mevblocker.io',
    // ETHEREUM_RPC: 'wss://eth-mainnet.ws.alchemyapi.io/v2/demo',
    // ETHEREUM_RPC: 'wss://mainnet.infura.io/ws/v3/9aa3d95b3bc440fa88ea12eaa4456161',
    // ETHEREUM_RPC: 'https://mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161',
    // ETHEREUM_RPC: 'wss://1rpc.io/eth',
    // ETHEREUM_RPC: 'wss://0xrpc.io/eth',
    // ETHEREUM_RPC: 'wss://ethereum-rpc.publicnode.com',
    ...
    // 超时设置
    REQUEST_TIMEOUT: 50000,              // API 请求超时时间 (毫秒)
